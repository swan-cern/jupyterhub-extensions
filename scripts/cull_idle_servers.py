...
Adapted to SWAN from: https://github.com/jupyterhub/jupyterhub/blob/2e872069fb8267d17fc0332f34ba0330abb5f05e/examples/cull-idle/cull_idle_servers.py
...
@coroutine
def cull_idle(url, api_token, inactive_limit, cull_users=False, local_home=False, max_age=0, concurrency=10):
